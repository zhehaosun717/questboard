...
export const TRANSLATIONS = {
  ...
  'status.needs_coordinator': { zh: '等 coordinator', en: 'Needs the coordinator' },
  'status.owner_ruled': { zh: '已裁决', en: 'Ruled' },
  ...
  // FB2-08: the shelf's dismissal bookkeeping and the per-kind breakdown of excluded files.
  'briefShelf.dismissButton': { zh: '已在板外完成/忽略', en: 'Done outside the board / ignore' },
  'briefShelf.dismissFailed': { zh: '归档失败：{error}', en: 'Dismiss failed: {error}' },
  'briefShelf.undismissFailed': { zh: '撤销失败：{error}', en: 'Undismiss failed: {error}' },
  'briefShelf.sameIdAs': { zh: '与 {primary} 同编号', en: 'Same id as {primary}' },
  'briefShelf.dismissedTitle': { zh: '已归档 {count} 份（可撤销）：', en: '{count} dismissed (undoable):' },
  'briefShelf.dismissNote': { zh: '　备注：{note}', en: ' note: {note}' },
  'briefShelf.undo': { zh: '撤销', en: 'Undo' },
  'briefShelf.kind.duplicate': { zh: '同编号的重复副本', en: 'Duplicate copies' },
  'briefShelf.kind.badId': { zh: '文件名不像委托编号', en: 'File name is not a package id' },
  'briefShelf.kind.unreadable': { zh: '不可读', en: 'Unreadable' },
  'briefShelf.kind.oversized': { zh: '文件太大', en: 'Oversized' },
  'briefShelf.kind.posted': { zh: '已经发布过', en: 'Already posted' },
  'briefShelf.kind.dispatched': { zh: '已经在别处登记过派遣', en: 'Dispatched elsewhere' },
  'briefShelf.kind.old': { zh: '超出时间窗口', en: 'Outside the time window' },
  'briefShelf.kind.symlink': { zh: '链接', en: 'Symlinks' },
  'briefShelf.kind.dismissed': { zh: '已归档', en: 'Dismissed' },
  'briefShelf.kind.other': { zh: '其它', en: 'Other' },
  ...
  'questCard.withAnnotations': { zh: '本次派遣包含 {count} 条批注', en: 'This dispatch carries {count} annotations' },
  ...
  'reviewSection.needsCoordinator': { zh: '需要 coordinator 处理', en: 'Needs the coordinator' },
  'reviewSection.handToCoordinator': { zh: '交给 coordinator 重写简报', en: 'Hand the brief to the coordinator for a rewrite' },
  'reviewSection.routedCoordinator': { zh: '{id} 已退回，等 coordinator 处理', en: '{id} sent back; waits on the coordinator' },
  'reviewSection.handedToCoordinator': { zh: '已请 coordinator 重写 {id} 的简报', en: 'Asked the coordinator to rewrite the brief of {id}' },
  'reviewSection.handFailed': { zh: '没交出去', en: 'Could not hand over' },
  ...
  // QuestDrawer.tsx — dossier chrome and its action prompts. Server-matched text (limit reasons, release
  // details) stays Chinese by design; these are the board's own words only.
  'drawer.close': { zh: '关闭', en: 'Close' },
  'drawer.eyebrow': { zh: 'DOSSIER · 委托档案', en: 'DOSSIER · QUEST FILE' },
  'drawer.postedBy': { zh: '发布者 {name}', en: 'Posted by {name}' },
  'drawer.briefLabel': { zh: '委托书', en: 'Brief' },
  'drawer.cancel.pending': { zh: '停止请求已发出，还没收到确认', en: 'Stop request sent, no confirmation yet' },
  'drawer.cancel.neverStarted': { zh: 'worker 还没启动', en: 'worker has not started' },
  'drawer.cancel.stoppedByWrapper': { zh: '包装脚本已停下它直接启动的进程', en: 'the wrapper stopped the process it started itself' },
  'drawer.cancel.stoppedByApi': { zh: '已通过通道接口停止', en: 'stopped through the lane API' },
  'drawer.cancel.manualRequired': { zh: '无法自动停止，需要手动处理', en: 'cannot stop automatically; needs manual handling' },
  'drawer.cancel.unknown': { zh: '不确定是否已停止', en: 'not sure whether it stopped' },
  'drawer.cancel.source.ui': { zh: '看板', en: 'board' },
  'drawer.cancel.source.cli': { zh: '命令行', en: 'CLI' },
  'drawer.cancel.source.mcp': { zh: 'MCP', en: 'MCP' },
  'drawer.cancel.source.limit': { zh: '超限自动取消', en: 'auto-cancelled over the limit' },
  'drawer.cancel.source.unknown': { zh: '未知来源', en: 'unknown source' },
  'drawer.cancel.from': { zh: '来自', en: 'from' },
  'drawer.cancel.reasonPrompt': { zh: '请写明取消原因', en: 'Write the reason for cancelling' },
  'drawer.cancel.heldPrompt': { zh: '请写明你怎么确认这个 worker 已经停了；这句话会记成手动释放的理由', en: 'Write how you confirmed this worker has stopped; it is recorded as the manual-release reason' },
  'drawer.cancel.warningHolds': { zh: '取消 {id}？它的 worker 可能还在改文件。取消只是发出停止请求，不代表 worker 已经停了。确定继续吗？', en: 'Cancel {id}? Its worker may still be editing files. Cancelling only sends a stop request; it does not mean the worker has stopped. Continue?' },
  'drawer.cancel.warning': { zh: '取消 {id}？', en: 'Cancel {id}?' },
  'drawer.cancel.defaultReason': { zh: '在看板上手动取消', en: 'cancelled manually on the board' },
  'drawer.cancel.failedToast': { zh: '取消失败：{error}', en: 'Cancel failed: {error}' },
  'drawer.resolve.failedToast': { zh: '手动释放失败：{error}', en: 'Manual release failed: {error}' },
  'drawer.resolve.button': { zh: '确认已停止，手动释放', en: 'Confirm stopped, release manually' },
  'drawer.cannotAutoStop': { zh: '无法自动停止，请手动处理', en: 'Cannot stop automatically; please handle it manually' },
  'drawer.release.confirm': { zh: '确认冒险者（编号 {name}）已经停了？释放后这个委托可以重新派；如果它其实还在跑，会有两个冒险者同时改文件。', en: 'Confirm adventurer (id {name}) has stopped? After release this quest can be dispatched again; if it is actually still running, two adventurers will edit files at once.' },
  'drawer.release.detail': { zh: 'owner 在看板上确认冒险者 {name} 已停止', en: 'owner confirmed on the board that adventurer {name} has stopped' },
  'drawer.release.failedToast': { zh: '释放失败：{error}', en: 'Release failed: {error}' },
  'drawer.release.hint': { zh: '它的位置和文件仍被占着。确认它真的停了再释放：如果它其实还在跑，释放后会有两个冒险者同时改文件。', en: 'Its slot and files are still reserved. Confirm it really stopped before releasing: if it is still running, releasing lets two adventurers edit files at once.' },
  'drawer.release.button': { zh: '确认已停，释放', en: 'Confirm stopped, release' },
  'drawer.onQuest.model': { zh: '模型 {model}', en: 'model {model}' },
  'drawer.onQuest.workerId': { zh: '编号 {name}', en: 'id {name}' },
  'drawer.onQuest.dispatchedAt': { zh: '{time} 派出', en: 'dispatched {time}' },
  'drawer.onQuest.heartbeat': { zh: '最近心跳：{seconds} 秒前', en: 'last heartbeat {seconds}s ago' },
  'drawer.reviewPage.answered': { zh: '已批注 {answered}/{total}', en: 'annotated {answered}/{total}' },
  'drawer.reviewPage.source': { zh: '评审页文件：评审目录/{source}', en: 'review page file: review/{source}' },
  'drawer.chatter.messages': { zh: '{count} 条', en: '{count} messages' },
  'drawer.chatter.closed': { zh: '已关闭', en: 'closed' },
  'drawer.rulings.question': { zh: '问：{question}', en: 'Q: {question}' },
  'drawer.rulings.answer': { zh: '答：{text}', en: 'A: {text}' },
  'drawer.scrap.button': { zh: '取消这个委托', en: 'Cancel this quest' },

  // reviewList.ts — review page list, filters, summaries and navigation hints.
  'review.statsFilter.all': { zh: '全部', en: 'All' },
  'review.statsFilter.available': { zh: '有统计', en: 'With stats' },
  'review.statsFilter.unavailable': { zh: '统计不可用', en: 'Stats unavailable' },
  'review.manifestUnreadable': { zh: '统计不可用 · 仅查看页面', en: 'Stats unavailable · view-only page' },
  'review.pageInfoUnreadable': { zh: '页面信息无法读取', en: 'Page info unreadable' },
  'review.progress': { zh: '已批注 {answered} / 共 {total}', en: 'Annotated {answered} / {total}' },
  'review.noneMatch': { zh: '没有符合条件的评审页', en: 'No matching review pages' },
  'review.allDone': { zh: '都处理完了', en: 'All handled' },
  'review.pendingCount': { zh: '{count} 份未处理', en: '{count} pending' },
  'review.completeCount': { zh: '{count} 份已完成', en: '{count} complete' },
  'review.emptyCount': { zh: '{count} 份无批注项', en: '{count} with no annotation sections' },
  'review.unknownCount': { zh: '{count} 份统计不可用', en: '{count} with unavailable stats' },
  'review.scopedPrefix': { zh: '筛选结果：{summary}', en: 'Filtered: {summary}' },
  'review.scopedEmpty': { zh: '共 0 份', en: '0 pages' },
  'review.emptyLoad': { zh: '暂无评审页，页面加载后会显示在这里。', en: 'No review pages yet; they appear here after loading.' },
  'review.noQueryMatch': { zh: '没有找到匹配的评审页，换个关键词或清空搜索试试。', en: 'No matching review pages; try another keyword or clear the search.' },
  'review.stillPending': { zh: '还有未处理的页面没有确认。', en: 'There are still unconfirmed pending pages.' },
  'review.filterHidesPending': { zh: '“{filter}”筛选把一些页面排除在外了，其中还有未处理的页面没有确认，取消筛选即可看到。', en: 'The "{filter}" filter hides some pages, including unconfirmed pending ones; clear the filter to see them.' },
  'review.pendingClearedUnknownLeft': { zh: '未处理的页面都清空了，但还有统计不可用的页面没有确认。', en: 'Pending pages are cleared, but pages with unavailable stats are still unconfirmed.' },
  'review.allDoneClearFilter': { zh: '都处理完了，可以取消筛选查看全部页面。', en: 'All handled; clear the filter to see every page.' },
  'review.noFilterMatch': { zh: '没有符合筛选条件的评审页。', en: 'No review pages match the filter.' },
  'review.nextUnanswered': { zh: '跳到下一份未处理页面', en: 'Jump to the next pending page' },
  'review.hiddenLaterPending': { zh: '筛选隐藏了后面 {count} 份未处理，清空筛选即可看到', en: 'The filter hides {count} later pending pages; clear it to see them' },
  'review.earlierPending': { zh: '后面没有未处理的了，前面还有 {count} 份未处理', en: 'None pending after this one; {count} pending before it' },
  'review.unsafeLaterPending': { zh: '后面还有 {count} 份未处理页面无法安全打开', en: '{count} later pending pages cannot be opened safely' },
  'review.unknownLeft': { zh: '已知的都处理完了，但还有统计不可用的页面', en: 'Known pages are handled, but some have unavailable stats' },
  'review.unnamedPage': { zh: '未命名页面', en: 'Untitled page' },
  'review.rootDir': { zh: '根目录', en: 'root' },

  // nextStep.ts — the dossier's next-step titles and hints.
  'step.who.you': { zh: '等你', en: 'waits on you' },
  'step.who.coordinator': { zh: '等 coordinator', en: 'waits on the coordinator' },
  'step.who.adventurer': { zh: '等冒险者', en: 'waits on an adventurer' },
  'step.who.reviewer': { zh: '等复核的冒险者', en: 'waits on the reviewing adventurer' },
  'step.advice.pass': { zh: '复核的冒险者认为通过。看一眼交回的东西，就可以验收。', en: 'The reviewing adventurer passed it. Look over what came back, then accept.' },
  'step.advice.findings': { zh: '复核通过，但列了问题。看完决定验收还是退回。', en: 'Review passed but listed problems. Read them, then accept or send back.' },
  'step.advice.fail': { zh: '复核的冒险者认为不通过。看完结论，多半要退回重做。', en: 'The reviewing adventurer failed it. Read the verdict; it will most likely go back for redo.' },
  'step.advice.unknown': { zh: '复核报告里没写结论，自己看报告再定。', en: 'The review report has no verdict; read the report and decide.' },
  'step.verdictCaution': { zh: '复核只是复核者的意见，不代表编译或测试跑过，也不算验收。', en: "A review is only the reviewer's opinion; it does not mean it compiles or that tests ran, and it is not acceptance." },
  'step.archived.ownerDone': { zh: '你做完了。', en: 'You finished it.' },
  'step.archived.coordinatorDone': { zh: 'coordinator 在看板上验收了。', en: 'The coordinator accepted it on the board.' },
  'step.archived.unknownDone': { zh: '在看板上验收了，但记录没写是谁。', en: 'Accepted on the board, but the record does not say by whom.' },
  'step.archived.ownerAccepted': { zh: '你在看板上验收了。', en: 'You accepted it on the board.' },
  'step.archived.notOnBoard': { zh: '已标成完成（不是在看板上验收的）。', en: 'Marked done (not accepted on the board).' },
  'step.archived.done': { zh: '已完成', en: 'Done' },
  'step.archived.superseded': { zh: '已被取代', en: 'Superseded' },
  'step.archived.cancelled': { zh: '已取消', en: 'Cancelled' },
  'step.archived.notNeeded': { zh: '这个委托不再需要做。', en: 'This quest no longer needs doing.' },
  'step.reviewing': { zh: '{name} 正在复核，', en: '{name} is reviewing, ' },
  'step.reviewUnassigned': { zh: '复核委托 {id} 还没派出去，打开它派一个冒险者。', en: 'Review {id} is not dispatched yet; open it and assign an adventurer.' },
  'step.reviewTail.coordinator': { zh: '结论回来后由 coordinator 核验处理。', en: 'The coordinator verifies once the verdict is back.' },
  'step.reviewTail.owner': { zh: '结论回来后这里等你验收。', en: 'It waits here for your acceptance once the verdict is back.' },
  'step.reviewPickCaution.coordinator': { zh: '挑复核模型只是请它看一遍，不等于验收。', en: 'Picking a review model only asks it to look; it is not acceptance.' },
  'step.reviewPickCaution.owner': { zh: '你也可以不等，直接验收或退回。', en: 'You can also not wait, and accept or send back directly.' },
  'step.reviewTitle': { zh: '等复核的冒险者：{id}', en: 'Waiting on reviewing adventurer: {id}' },
  'step.coordinatorTitle': { zh: '等 coordinator 验收 · 复核{verdict}', en: 'Waits on coordinator acceptance · review {verdict}' },
  'step.ownerTitle': { zh: '等你验收 · 复核{verdict}', en: 'Waits on your acceptance · review {verdict}' },
  'step.coordinatorVerdictBack': { zh: '复核结论已回，由 coordinator 核验后验收或退回。{caution}', en: 'The review verdict is back; the coordinator verifies, then accepts or sends back. {caution}' },
  'step.coordinatorWaitTitle': { zh: '等 coordinator 核验', en: 'Waits on the coordinator to verify' },
  'step.coordinatorWaitDetail': { zh: '冒险者说做完了，还没人核实。代码和工具的核验归 coordinator：查交回的东西、跑测试，再验收或退回。要模型复核，把名册里的冒险者拖到这张委托上（那只是选复核者，不是验收）。', en: "The adventurer says it is done; nobody has verified it yet. Verifying code and tool work is the coordinator's job: check what came back, run the tests, then accept or send back. To have a model review it, drag an adventurer from the roster onto this quest (that only picks a reviewer, not acceptance)." },
  'step.ownerWaitTitle': { zh: '等你验收', en: 'Waits on your acceptance' },
  'step.ownerWaitDetail': { zh: '冒险者说做完了，还没人核实。看完交回的东西，验收或退回；想先让模型复核，把冒险者拖到这张委托上。', en: 'The adventurer says it is done; nobody has verified it yet. Look over what came back, then accept or send back; to have a model review it first, drag an adventurer onto this quest.' },
  'step.delivery.review': { zh: '做完会把结论记回它复核的委托。', en: 'When done, the verdict is recorded on the quest it reviews.' },
  'step.delivery.coordinator': { zh: '做完会交差，由 coordinator 核验，不用你验收。', en: 'When done it hands in work for the coordinator to verify; you do not need to accept it.' },
  'step.delivery.owner': { zh: '做完会交差等你验收。', en: 'When done it hands in work and waits for your acceptance.' },
  'step.open.failed': { zh: '上次失败了。', en: 'It failed last time.' },
  'step.open.limited': { zh: '上次被限额退回。', en: 'It bounced on a quota limit last time.' },
  'step.open.title': { zh: '可以派 · {count} 个冒险者能接', en: 'Dispatchable · {count} adventurers can take it' },
  'step.open.detail': { zh: '{again}把名册里的冒险者拖到这张委托上派它去做，{delivery}', en: '{again}Drag an adventurer from the roster onto this quest to dispatch it; {delivery}' },
  'step.open.eachOwnReason': { zh: '每个冒险者各有原因，打开看。', en: 'Each adventurer has its own reason; open it to see.' },
  'step.open.titleBlocked': { zh: '暂时派不了', en: 'Not dispatchable right now' },
  'step.ownerQuestion': { zh: '有一个问题等你拍板。', en: 'There is a question waiting for your decision.' },
  'step.ownerQuestionAfter.owner': { zh: '拍板后写下决定，做完点「做完了」。', en: 'Write the decision after you make it, and click 做完了 when done.' },
  'step.ownerQuestionAfter.dispatch': { zh: '拍板后委托回到委托板，可以派冒险者。', en: 'After the decision the quest returns to the board and can be dispatched.' },
  'step.ownerQuestionTitle': { zh: '等你拍板', en: 'Waits on your decision' },
  'step.reviewVerdictTitle': { zh: '复核结论：{verdict}', en: 'Review verdict: {verdict}' },
  'step.reviewBack.coordinator': { zh: '复核报告交回来了。{parent} 是技术活，核验和处置归 coordinator，不用你验收；结论就在报告里。', en: "The review report is back. {parent} is technical work; verifying and handling it is the coordinator's job, not your acceptance; the verdict is in the report." },
  'step.reviewBack.unknown': { zh: '复核报告交回来了，但{reason}，说不准该谁处理，找 coordinator 核实。', en: 'The review report is back, but {reason}; it is unclear who should handle it, so ask the coordinator to check.' },
  'step.reviewBack.unknownNoParent': { zh: '没记录它复核哪个委托', en: 'there is no record of which quest it reviews' },
  'step.reviewBack.unknownParentGone': { zh: '它复核的 {parent} 不在看板上', en: 'the quest it reviews, {parent}, is not on the board' },
  'step.reviewBack.owner': { zh: '复核报告交回来了。去 {parent} 看结论，决定验收还是退回。', en: 'The review report is back. Open {parent} to read the verdict and decide to accept or send back.' },
  'step.ownerRuledDetail': { zh: '你已经做过决定。没别的事就点「做完了」，委托标成已完成。', en: 'You already made the decision. When there is nothing else, click 做完了 to mark the quest done.' },
  'step.ownerTodoDetail': { zh: '这件事不派给冒险者。想好写下来，做完点「做完了」，委托标成已完成。', en: 'This one is not dispatched to adventurers. Think it over, write it down, then click 做完了 to mark it done.' },
  'step.ownerTodoTitle': { zh: '等你亲自做', en: 'Waits on you to do it' },
  'step.playtestTitle': { zh: '等你试玩', en: 'Waits on your playtest' },
  'step.needsCoordinatorTitle': { zh: '等 coordinator 处理退回', en: 'Waits on the coordinator' },
  'step.needsCoordinatorDetail': { zh: '退回的批注点名要 coordinator 处理，处理完再重派', en: 'The send-back asks for the coordinator; redispatch after it is handled' },
  'step.ruledTitle': { zh: '等 coordinator 导入', en: 'Waits for the coordinator to import' },
  'step.ruledArtDetail': { zh: '评审结论已保存，coordinator 按结论导入结果', en: 'The verdicts are saved; the coordinator imports accordingly' },
  'step.ruledDetail': { zh: '评审结论已保存，等 coordinator 处理', en: 'The verdicts are saved; waits on the coordinator' },
  'step.playtestDetail': { zh: '试玩后把结论写下来，会记进裁决记录。', en: 'After the playtest, write the verdict down; it is recorded as a ruling.' },
  'step.dispatchedNoRecordTitle': { zh: '进行中，但没记录冒险者', en: 'In progress, but no adventurer recorded' },
  'step.dispatchedNoRecordDetail': { zh: '看板对不上这个委托，找 coordinator 核实。', en: 'The board does not line up with this quest; ask the coordinator to check.' },
  'step.dispatchedReviewAfter': { zh: '做完会自动交差，结论记回它复核的委托。', en: 'When done it hands in automatically, and the verdict is recorded on the quest it reviews.' },
  'step.dispatchedCoordinatorAfter': { zh: '做完会自动交差，进入 coordinator 核验。', en: 'When done it hands in automatically and goes to coordinator verification.' },
  'step.dispatchedOwnerAfter': { zh: '做完会自动交差，等你验收。', en: 'When done it hands in automatically and waits for your acceptance.' },
  'step.dispatchedTitle': { zh: '{name} 在做', en: '{name} is working' },
  'step.stalledTitle': { zh: '等你确认：冒险者没动静', en: 'Waits on you: the adventurer went quiet' },
  'step.stalledDetail': { zh: '{name}（编号 {worker}）很久没输出，可能还在跑。确认它停了再释放，释放后才能重新派。', en: '{name} (id {worker}) has been quiet for a long time and may still be running. Confirm it stopped before releasing; only then can it be dispatched again.' },
  'step.noneTitle': { zh: '没有下一步', en: 'No next step' },
  'step.noneDetail': { zh: '状态是「{status}」，看板不知道接下来该谁做。', en: 'Status is "{status}"; the board does not know whose turn is next.' },
  ...
  // server-written acceptance strings (owner 验收 / coordinator 验收 / 验收通过) stay Chinese on purpose.
  'rung.claimed': { zh: '冒险者交差', en: 'Adventurer hands in' },
  'rung.notDispatched': { zh: '还没派过冒险者', en: 'Not dispatched yet' },
  'rung.noWorkerName': { zh: '没记录是谁交的差', en: 'no record of who handed in' },
  'rung.claimedDone': { zh: '{who} 说做完了——它自己说的，不算核实', en: '{who} says it is done — its own word, not verified' },
  'rung.claimedUnknown': { zh: '有交差记录但说不清是谁，不算核实', en: 'A hand-in is recorded but it is unclear who, so it is not verified' },
  'rung.claimedWorking': { zh: '{who} 还在做', en: '{who} is still working' },
  'rung.claimedWorkingUnknown': { zh: '冒险者还在做（名字没记录）', en: 'An adventurer is still working (name not recorded)' },
  'rung.notHandedIn': { zh: '还没交差', en: 'Not handed in yet' },
  'rung.reviewed': { zh: '复核结论', en: 'Review verdict' },
  'rung.noReview': { zh: '没有派复核', en: 'No review dispatched' },
  'rung.reviewing': { zh: '{id} 复核中', en: '{id} reviewing' },
  'rung.reviewNotDispatched': { zh: '{id} 还没派出去', en: '{id} not dispatched yet' },
  'rung.reviewedNote': { zh: '{id}：复核{verdict}', en: '{id}: review {verdict}' },
  'rung.accepted.coordinator': { zh: 'coordinator 验收', en: 'coordinator accepts' },
  'rung.accepted.you': { zh: '你验收', en: 'you accept' },
  'rung.mismatch.coordinator': { zh: '（技术活本该 coordinator 先核验）', en: ' (technical work should be verified by the coordinator first)' },
  'rung.mismatch.owner': { zh: '（这本该由你验收）', en: ' (this should be your acceptance)' },
  'rung.ownerBoardAccept.technical': { zh: '你在看板上验收（技术活本该 coordinator 先核验）', en: 'You accepted on the board (technical work should be verified by the coordinator first)' },
  'rung.ownerBoardAccept': { zh: '你在看板上验收', en: 'You accepted on the board' },
  'rung.coordinatorBoardAccept': { zh: 'coordinator 在看板上验收', en: 'The coordinator accepted on the board' },
  'rung.coordinatorBoardAccept.mismatch': { zh: 'coordinator 在看板上验收（这本该由你验收）', en: 'The coordinator accepted on the board (this should be your acceptance)' },
  'rung.acceptedUnknownActor': { zh: '看板上记了验收，没写是谁', en: 'Acceptance recorded on the board, but not by whom' },
  'rung.doneNotOnBoard': { zh: '已标成完成，不是在看板上验收的', en: 'Marked done, not accepted on the board' },
  'rung.acceptedUnknownLabel': { zh: '验收（记录没写是谁）', en: 'Accepted (record does not say by whom)' },
  'rung.superseded': { zh: '委托已不再需要', en: 'Quest no longer needed' },
  'rung.waitCoordinator': { zh: '等 coordinator 核验', en: 'waits on the coordinator to verify' },
  'rung.waitYou': { zh: '等你验收', en: 'waits on your acceptance' },
  'rung.notThereYet': { zh: '还没到这一步', en: 'Not at this step yet' },
